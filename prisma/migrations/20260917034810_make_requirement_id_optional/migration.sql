...
INSERT INTO "new_Requirement" ("content", "createdAt", "currentNode", "date", "developmentDays", "id", "isReleased", "isUrgent", "releaseDate", "remark", "requirementId", "system", "title", "updatedAt", "workOrderId") SELECT "content", "createdAt", "currentNode", "date", "developmentDays", "id", "isReleased", "isUrgent", "releaseDate", "remark", "requirementId", "system", "title", "updatedAt", "workOrderId" FROM "Requirement";
